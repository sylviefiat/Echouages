...
<div id="<?php echo $this->form->jForm->jforms_id ?>_wizard" class="wizard" style="<?php echo $style; ?>">
	<ul class="steps">
	<?php
			$countFset = 0;
			foreach($steps as $step){
				...
				?>				
				<li data-target="#<?php echo $this->form->jForm->jforms_id .'Step'. $countFset ?>" class="step">
...
<?php
	...
	foreach($steps as $step){
		...
		$fieldsets = $formParts_fieldsets[$step['id']];
		?>
		<div class="step-pane" id="<?php echo $this->form->jForm->jforms_id ?>Step<?php echo ($countFset) ?>">
