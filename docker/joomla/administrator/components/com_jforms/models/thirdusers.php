...
* @subpackage	Classes
*/
class JformsCkModelThirdusers extends JformsClassModelList
{
	/**
...
if (!class_exists('JformsModelThirdusers')){ class JformsModelThirdusers extends JformsCkModelThirdusers{} }
