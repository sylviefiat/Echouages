...
* @subpackage	Form
*/
class JFormFieldModal_Thirdusergroup extends JdomClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'JFORMS_DATA_PICKER_SELECT_USERGROUP';
...
if (!class_exists('JFormFieldModal_Thirdusergroup')){ class JFormFieldModal_Thirdusergroup extends JformsCkJFormFieldModal_Thirdusergroup{} }
