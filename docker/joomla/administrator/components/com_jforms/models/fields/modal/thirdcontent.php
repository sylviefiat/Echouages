...
* @subpackage	Form
*/
class JFormFieldModal_Thirdcontent extends JdomClassFormFieldModal
{
	/**
	...
	* @var string
	*/
	protected $_nullLabel = 'JFORMS_DATA_PICKER_SELECT_CONTENT';
...
if (!class_exists('JFormFieldModal_Thirdcontent')){ class JFormFieldModal_Thirdcontent extends JformsCkJFormFieldModal_Thirdcontent{} }
