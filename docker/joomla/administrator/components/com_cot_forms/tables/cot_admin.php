...
/**
 * cot_admin Table class
 */
class Cot_formsTablecot_Admin extends JTable {
    ...
    public function bind($array, $ignore = '') {
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_cot_forms.cot_admin.' . $array['id'])) {
            $actions = JFactory::getACL()->getActions('com_cot_forms', 'cot_admin');
            $default_actions = JFactory::getACL()->getAssetRules('com_cot_forms.cot_admin.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_cot_forms.cot_admin.' . (int) $this->$k;
    }
    ...
    protected function _getAssetParentId(JTable $table = null, $id = null) {
        ...
        $assetParent->loadByName('com_cot_forms');
     ...
     * @since    2.0.7
     */
    public function validate($pk = null) {
