...
class Stranding_formsTableStranding_Admin extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__stranding_admin', 'id', $db);
    }
    ...
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_stranding_forms.stranding_admin.' . (int) $this->$k;
    }
    ...
    protected function _getAssetParentId(JTable $table = null, $id = null) {
        ...
        $assetParent->loadByName('com_stranding_forms');
    ...
    public function delete($pk = null) {
     ...
     /**
     * Method to set the validation state for a row. USED TO VALIDATE STRANDING FORM FROM PUBLIC.
     *
