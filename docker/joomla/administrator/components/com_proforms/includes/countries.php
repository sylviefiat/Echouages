...
$GLOBALS["m4jCountries"] = array(
	...
	array("name"=>"Bosnia and Herzegowina", "code"=>"BA"),
	...
	array("name"=>"France, Metropolitan", "code"=>"FX"),
	...
	array("name"=>"Heard and Mc Donald Islands", "code"=>"HM"),
	...
	array("name"=>"Slovakia (Slovak Republic)", "code"=>"SK"),
	...
	array("name"=>"St. Helena", "code"=>"SH"),
	array("name"=>"St. Pierre and Miquelon", "code"=>"PM"),
	array("name"=>"Sudan", "code"=>"SD"),
	array("name"=>"Suriname", "code"=>"SR"),
	array("name"=>"Svalbard and Jan Mayen Islands", "code"=>"SJ"),
	...
	array("name"=>"Vatican City State (Holy See)", "code"=>"VA"),
	...
	array("name"=>"Wallis and Futuna Islands", "code"=>"WF"),
	array("name"=>"Western Sahara", "code"=>"EH"),
	array("name"=>"Yemen", "code"=>"YE"),
	array("name"=>"Yugoslavia", "code"=>"YU"),
	array("name"=>"Zaire", "code"=>"ZR"),
	array("name"=>"Zambia", "code"=>"ZM"),
	array("name"=>"Zimbabwe", "code"=>"ZW")
);
	
function m4jCountries2JSON($jsVar = null){
	$jsVar = $jsVar ? 'var '.$jsVar . ' = ' : null;
	$cArray= array();
	foreach($GLOBALS["m4jCountries"] as $country){
		array_push($cArray,  "\t" . '{ name: "'.$country["name"].'", code: "'.$country["code"].'" }' );
	}
	return $jsVar . "{\n". implode(",\n",$cArray) ."\n};";
}	

define("_M4J_COUNTRY_ONLY_NAMES", 1);
define("_M4J_COUNTRY_ONLY_ISO", 2);
define("_M4J_COUNTRY_NAME_AND_ISO", 3);

function m4jCountryDropDownArray($format = _M4J_COUNTRY_ONLY_NAMES){
	$array = array();
	foreach($GLOBALS["m4jCountries"] as $country){
		switch ($format){	
			default: 
			case _M4J_COUNTRY_ONLY_NAMES: 
				array_push($array, array("val" => $country["name"], "text"=> $country["name"]  ) );
				break;
				
			case _M4J_COUNTRY_ONLY_ISO: 
				array_push($array, array("val" => $country["code"], "text"=> $country["code"]  ) );				
				break;
				
			case _M4J_COUNTRY_NAME_AND_ISO: 
				array_push($array, array("val" => $country["code"], "text"=> $country["name"]  ) );
				break;
		}
	}
	return $array;
