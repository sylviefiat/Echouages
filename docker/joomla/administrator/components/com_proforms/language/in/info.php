	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td align="left" valign="top"><h3>Mooj Proforms Basic V <?PHP echo MVersion::getFull(); ?> </h3>
          ...
          Mooj Proforms Basic dipublikasikan dibawah lisensi GNU GPL. Tidak ada garansi atas fungsionalitas atau kelengkapan.  Mad4Media tidak bertnggung-jawab atas kerusakan yang disebabkan oleh komponen ini..<br>
          <br>
              ...
              <tr>
                <td width="100%" height="100%" align="left" valign="top"><h3>Mooj Home</h3>
                  <p>Untuk itu andan akan mendapatkan informasi secara eksplisit di beranda mad4media.
                    ...
                    Anda dapat membuka halaman proyek di: <a href="http://www.mooj.org" target="_blank">www.mooj.org
                  </a></p>
