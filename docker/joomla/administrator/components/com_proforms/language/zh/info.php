	    ...
	    <table width="100%" border="0" cellspacing="10" cellpadding="0">
          <tr>
			...
			<ul>
              ...
              <tr>
                <td width="100%" height="100%" align="left" valign="top"><h3>Mooj 官方网站</h3>
                  <p>在 Mooj 官方网站你可以获取详细的信息。
                    <br />
                    我们对任何语言的翻译都表示感谢. 你可以从下面地址下载单独的语言文件包，（在此基础上翻译）完后将你的成果发送给我们。我们将把它添加到安装包中，公开发行。<br />
                    下载地址：<a href="http://www.mooj.org" target="_blank">www.mooj.org
                  </a></p>
