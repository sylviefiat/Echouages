...
{
	map=document.getElementById(id+"_elementform_id_temp");
	w_long = typeof gmapdata[id]!= 'undefined' && typeof gmapdata[id].getCenter() != 'undefined' ? gmapdata[id].getCenter().lng() : '2.294254';
	w_lat = typeof gmapdata[id]!= 'undefined' && typeof gmapdata[id].getCenter() != 'undefined' ? gmapdata[id].getCenter().lat() : '48.858334';
