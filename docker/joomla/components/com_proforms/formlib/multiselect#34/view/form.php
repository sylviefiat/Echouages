...
class MFormMultiselect extends MFormElement {
	...
	protected function _renderDefault() {
		...
		$out .= '<select '.$eval.'class="m4jMultipleSelection '.$this->_getClass().'" id="m4j-'.$this->eid.'" name="m4j-'.$this->eid.'[]" size="'.$this->params->element_rows.'" multiple="multiple" ' . $this->_getStyle() . '>'."\n";
					for($t=0;$t<$count;$t++){
