...
<div id="captchaWrap" style="text-align: <?php echo $this->align;?>">
	...
	<div id="proformsCaptcha">
		...
		<div class="alignImage">
			<img src="index.php?option=com_proforms&amp;cpta=3&amp;uidx=<?php echo (int) $this->uniqueIndex; ?>&amp;rand=<?php echo uniqid(); ?>"  id="m4jCIM<?php echo (int) $this->uniqueIndex; ?>" alt="Proforms" />
		</div>
