...
* @subpackage	Classes
*/
class JformsCkModelThirdviewlevel extends JformsClassModelItem
{
	/**
	* View list alias
	*
	...
	* @since	1.6
	*/
	public function getTable($type = 'thirdviewlevel', $prefix = 'JformsTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_jforms.edit.viewlevel.data', array());
...
if (!class_exists('JformsModelThirdviewlevel')){ class JformsModelThirdviewlevel extends JformsCkModelThirdviewlevel{} }
