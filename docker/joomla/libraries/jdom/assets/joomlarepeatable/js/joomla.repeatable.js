...
(function ($) {
    $.JRepeatable = function (elid, names, field, maximum) {
        ...
        makeWin = function () {
            ...
            var applyButton = $('<a href="#" onClick="return false;" class="btn button btn-primary"/>').text(Joomla.JText._('JAPPLY'));
            ...
            var cancelButton = $('<a href="#" onClick="return false;" class="btn button btn-link"/>').text(Joomla.JText._('JCANCEL'));
        ...
        watchButtons = function () {
            win.on('click', 'span.add', function (e) {
                if (tr = findTr(e)) {
            ...
            win.on('click', 'span.remove', function (e) {
                if (tr = findTr(e)) {
                    tr.remove();
                    var rowcount = document.getElementById(elid + '_table').getElementsByTagName('tbody')[0].getElementsByTagName('tr').length;
        ...
        store = function () {
			...
			el.find('tbody tr').each(function(ind){
				obj = {};				
			   // Get the current values
				for (i = 0; i < names.length; i++) {
					n = names[i];
					fields = $(this).find('[name*="[' + n + ']"]');
					obj[n] = '';
