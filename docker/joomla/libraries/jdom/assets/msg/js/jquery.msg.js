  ...
  $.msg = function(){
    ...
    _ = {
      ...
      unblock : function(){
		...
		$( '#jquery-msg-overlay' ).hide().remove(); 
		/*
        $( '#jquery-msg-overlay' ).hide( configs.fadeOut, function(){
          // beforeUnblock event callback
          beforeUnblock[ configs.msgID ]( $(this) );
    ...
    if( type === '[object String]' ){
	  ...
	  $('body').find('#jquery-msg-overlay').remove();
      ...
      $overlay = $(
        '<div id="jquery-msg-overlay" class="' + configs.klass + '" style="position:absolute; z-index:' + configs.z + '; top:0px; right:0px; left:0px; height:' + $( doc ).height() + 'px;">' +
          '<img src="' + configs.bgPath + '" id="jquery-msg-bg" style="width: 100%; height: 100%; top: 0px; left: 0px;"/>' +
...
jQuery(document).ready(function(){
	jQuery(window).resize(function(){
	   jQuery('body').find('#jquery-msg-content').center();
	});
});