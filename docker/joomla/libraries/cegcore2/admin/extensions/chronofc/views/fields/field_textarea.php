...
<div class="two fields">
	...
	<div class="four wide field">
		...
		<input type="text" value="5" name="Connection[views][<?php echo $n; ?>][fields][<?php echo $field_number; ?>][rows]">
	</div>
</div>
...
<div class="two fields">
	<div class="field">
		...
		<textarea name="Connection[views][<?php echo $n; ?>][fields][<?php echo $field_number; ?>][value]" rows="3"></textarea>
	</div>
	<div class="field">
		<label><?php el('Placeholder'); ?></label>
		<textarea name="Connection[views][<?php echo $n; ?>][fields][<?php echo $field_number; ?>][placeholder]" rows="3"></textarea>
	</div>
</div>
