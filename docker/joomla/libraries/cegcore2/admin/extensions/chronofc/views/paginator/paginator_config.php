...
<div class="ui segment tab views-tab active" data-tab="view-<?php echo $n; ?>">
	...
	<div class="ui bottom attached tab segment active" data-tab="view-<?php echo $n; ?>-general">
		<input type="hidden" value="paginator" name="Connection[views][<?php echo $n; ?>][type]">
		...
		<div class="two fields">
			<div class="field">
				...
				<select name="Connection[views][<?php echo $n; ?>][display]" class="ui fluid dropdown">
					<option value="navigation"><?php el('Navigation menu'); ?></option>
					<option value="limiter"><?php el('List length switcher'); ?></option>
					<option value="both"><?php el('Navigation & Length switcher'); ?></option>
				</select>
				<small><?php el('Choose the output elements of the paginator.'); ?></small>
			</div>
		</div>
