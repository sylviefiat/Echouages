...
<div class="ui segment tab views-tab active" data-tab="view-<?php echo $n; ?>">
	...
	<div class="ui bottom attached tab segment active" data-tab="view-<?php echo $n; ?>-general">
		<input type="hidden" value="sorter" name="Connection[views][<?php echo $n; ?>][type]">
		...
		<div class="two fields">
			<div class="field">
				<label><?php el('Field'); ?></label>
				<input type="text" value="" name="Connection[views][<?php echo $n; ?>][field]">
				<small><?php el('The name of the field to be sorted when clicking this sorting link, example: Model.field_name'); ?></small>
			</div>
		</div>
		...
		<div class="two fields">
			<div class="field">
				...
				<small><?php el('The content of the sorting link.'); ?></small>
			</div>
		</div>
