...
<div class="two fields">
	...
	<div class="four wide field">
		...
		<select name="Connection[views][<?php echo $n; ?>][fields][<?php echo $field_number; ?>][layout]" class="ui fluid dropdown">
...
<div class="two fields">
	...
	<div class="six wide field">
		<label><?php el('Checked values'); ?></label>
...
<div class="ui fluid accordion">
	...
	<div class="content fields_events_list">
		...
		<div class="fields">
			<input type="hidden" value="1" name="Connection[views][<?php echo $n; ?>][fields][<?php echo $field_number; ?>][events][<?php echo $ke; ?>][group]">
