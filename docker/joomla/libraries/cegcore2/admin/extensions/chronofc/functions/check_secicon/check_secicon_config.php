...
<div class="ui segment tab functions-tab active" data-tab="function-<?php echo $n; ?>">
	...
	<div class="ui bottom attached tab segment active" data-tab="function-<?php echo $n; ?>-general">
		<input type="hidden" value="check_secicon" name="Connection[functions][<?php echo $n; ?>][type]">
		...
		<div class="ui segment active" data-tab="function-<?php echo $n; ?>">
			...
			<div class="two fields">
				<div class="field required">
					...
					<input type="text" value="" name="Connection[functions][<?php echo $n; ?>][field_name]">
					<small><?php el('The name of the security image field must be provided here.'); ?></small>
				</div>
			</div>
			
			<div class="field">
				<label><?php el('Error message'); ?></label>
				<input type="text" value="You didn't select the correct image." name="Connection[functions][<?php echo $n; ?>][failed_error]">
			</div>
