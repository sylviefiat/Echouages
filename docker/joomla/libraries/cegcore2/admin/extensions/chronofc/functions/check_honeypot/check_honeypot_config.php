...
<div class="ui segment tab functions-tab active" data-tab="function-<?php echo $n; ?>">
	...
	<div class="ui bottom attached tab segment active" data-tab="function-<?php echo $n; ?>-general">
		<input type="hidden" value="check_honeypot" name="Connection[functions][<?php echo $n; ?>][type]">
		...
		<div class="ui segment active" data-tab="function-<?php echo $n; ?>">
			...
			<div class="two fields">
				<div class="field required">
					...
					<small><?php el('The name of the honeypot field must be provided here.'); ?></small>
				</div>
			</div>
			
			<div class="field">
				<label><?php el('Error message'); ?></label>
				<input type="text" value="You did not pass the honeypot test." name="Connection[functions][<?php echo $n; ?>][failed_error]">
			</div>
